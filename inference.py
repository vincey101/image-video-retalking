...
def main():    
    # Get CUDA device from environment
...
if __name__ == '__main__':
    ...
    parser.add_argument('--face', type=str, help='Path to video/image file containing faces')
    parser.add_argument('--audio', type=str, help='Path to audio file')
    parser.add_argument('--outfile', type=str, default='results/output.mp4', help='Path to save output video')
    parser.add_argument('--static', action='store_true', help='If True, use the first frame for the entire video')
    ...
    parser.add_argument('--exp_img', type=str, default=None, help='Expression template. neutral, smile or image path')
    parser.add_argument('--one_shot', action='store_true')
    parser.add_argument('--up_face', type=str, default='original', help='original, sad, angry, surprise')
    parser.add_argument('--without_rl1', action='store_true', help='Do not use the relative l1')
    parser.add_argument('--img_size', type=int, default=384)
    parser.add_argument('--LNet_batch_size', type=int, default=16)
    ...
    # Check if input is image and convert if necessary
    if is_image_file(args.face):
        print("Processing input image...")
        video_path = create_video_from_image(args.face)
